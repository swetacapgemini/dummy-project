...
export default function LogOrsign({ history }) {
    ...
    const submitData = e => {
        ...
        logFunc.logUserIn(userData)
            ...
            .then(data => {
              //  let { token } = data
                sessionStorage.setItem('authToken', userData.email)
                history.push('/routes')
            })
    }
                                ...
                                <div className="form-input">
                                    ...
                                    <form onSubmit={(e) => { submitData(e) }}>
                                        <div class="form-group">
                                            <input className="loginInfo" type="email" name="email" required onChange={e => handleChangeEvent(e, 'email')} />
                                        ...
                                        <div>
                                            ...
                                            <span className="signUPtext"><a href="/#" onClick={(e) => getToAdminLogin(e)}>AdminLogin</a></span>
                                        </div>
                                    </form>
                                </div>
                            </div>
